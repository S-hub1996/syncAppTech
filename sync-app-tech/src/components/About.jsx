    ...
    return (
        <Container py={10} name='test2' maxWidth={'container.xl'} textAlign={'center'} lineHeight={'110%'}>
            ...
            <Heading py={5}
                ...
                fontWeight={'bold'}
                color={'gray.700'}>SyncApp Technologies</Heading>
            <Text margin={'auto'}
                width={'70%'}
                fontFamily={'Inter'}
                fontWeight={'medium'}
                color={'gray.500'}>Your Gateway to Digital Success!
            </Text>

            <Text p={['10']} py={4} textAlign={'justify'} lineHeight={'6'} color={'gray.600'} fontSize={{ base: 'sm', sm: 'lg' }}>
            ...
            <Text px={['10']} py={4} textAlign={'justify'} lineHeight={'6'} color={'gray.600'} fontSize={{ base: 'sm', sm: 'lg' }}>
            ...
            <Heading py={5}
                ...
                fontFamily={'Work Sans'}
                fontWeight={'bold'}
                color={'gray.700'} > Why Choose SyncApp Technologies?</Heading>

            <OrderedList px={['10']} textAlign={'justify'} color={'gray.600'}>
                <ListItem py={4}>
